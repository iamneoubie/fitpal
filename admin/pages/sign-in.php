...
$errorMessage = $_SESSION['admin_login_error'] ?? '';
    ...
    <div class="container">
        <div class="sign-in-card">
            <div class="sign-in-header">
                ...
                <p class="text-muted">Sign in to manage restaurant and rider verification</p>
            </div>
            ...
            <form method="POST" action="../backend/handlers/sign-in-handler.php" class="sign-in-form" id="signInForm">
                ...
                <div class="sign-in-footer">
                    <p class="text-muted">
                        <a href="<?php echo $assetBase; ?>../index.php">Back to Home</a>
                    </p>
                </div>
            </form>
        </div>
