...
$successMessage = $_SESSION['admin_registration_success'] ?? '';
unset($_SESSION['login_error'], $_SESSION['admin_registration_success']);
?>
    ...
    <div class="container">
        <div class="sign-in-card">
            <div class="sign-in-header">
                <p class="heading-2">Admin <span>Portal</span></p>
            ...
            <form method="POST" action="../backend/handlers/sign-in-handler.php" class="sign-in-form" id="signInForm">
                ...
                <div class="sign-in-footer">
                    <p class="text-muted">
                        ...
                        <a href="<?php echo $assetBase; ?>../index.php">Return to FitPal</a>
                    </p>
                </div>
            </form>
        </div>
...
<script src="../assets/ui/js/sign-out.js" defer></script>
