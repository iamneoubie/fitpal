 ...
 *
 * Client-side validation + password visibility toggle. All real
 * validation runs server-side in sign-in-handler.php.
 *
 * @package FitPal
 * @version 1.0
 */
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // ============================================
        // PASSWORD TOGGLE
        // Icon paths are relative to the PAGE (admin/pages/)
        // → shared/ = ../../shared/
        // ============================================
